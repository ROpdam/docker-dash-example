...
app.layout = html.Div(
    [
        html.Div('Regression fit example', 
            style={'fontSize': 28, 'marginLeft':'40px', 'marginBottom':'50px', 'font-weight': 'bold', 'marginTop':'20px'}),
        html.Div(
            [
               dcc.Graph(id="regression_plot"),
               html.P('Standard Deviation', style={'color':'black', 'marginLeft':'20px'}),
               dcc.Slider(
                    id='std_slider',
                    min=0,
                    max=40,
